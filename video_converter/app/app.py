...
-x264-params me=-x264-params:me=rc-lookahead=10:bframes=16:\
b-pyramid=none:weightp=0:me=umh:subme=11:8x8dct=0 \
...
def make_thumbnail(inp):
    ...
    out = os.popen(
        f"""
ffmpeg -i "{input_path}" -f image2 -ss {thumbnail_seconds} \
-frames 1 -s 160x120 "{output_path}"
"""
    )
    print(out.read())
